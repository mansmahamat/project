...
import { User, Edit3, Save, X, Dumbbell, Activity } from 'lucide-react-native';
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.emptyState}>
          ...
          <TouchableOpacity style={styles.setupButton} onPress={goToOnboarding}>
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statValue}>
              {userProfile.stance.charAt(0).toUpperCase() + userProfile.stance.slice(1)}
            </Text>
          </View>
        </View>
        ...
        {/* Experience & Goals */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Boxing Experience</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.fitnessLevel}>
            {userProfile.fitnessLevel.charAt(0).toUpperCase() + userProfile.fitnessLevel.slice(1)} Activity Level
          </Text>
        </View>
        ...
        {userProfile.injuries && (
          <View style={styles.section}>
            ...
            <Text style={styles.injuriesText}>{userProfile.injuries}</Text>
          </View>
        )}
        ...
        {/* Additional Options */}
        <View style={styles.section}>
          <TouchableOpacity style={styles.recalibrateButton} onPress={goToOnboarding}>
            <Activity size={16} color="#FF6B35" />
            <Text style={styles.recalibrateText}>Retake Profile Quiz</Text>
          </TouchableOpacity>
          <Text style={styles.recalibrateDescription}>
            Go through the full setup process again to recalibrate your recommendations
          </Text>
        </View>
      </ScrollView>
    </View>
